...
- The methods were already thaught to the computer
...
Use hosting servers to share and colaborate
...
.pull-left-40[
- **Sweave**
  - It's in R since the beggining of times
...
- Recorded packages are downloaded and installed in the fisrt use
  - In R: `renv`
  - In Python: `venv`
]
...
- Virtualization of an environment at the **operating system** level
- Containers are isolated from each other and can have their own
  softwares in any specific version
...
xaringanBuilder::build_pdf("slides-y-isa.Rmd")
```
